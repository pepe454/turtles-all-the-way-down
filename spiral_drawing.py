...
#creates spiral drawing

def distance(p1, p2):
    inside = (p1[0] - p2[0])**2 + (p1[1] - p2[1])**2
    return sqrt(inside)
...
pygame.display.set_caption("Create spiral drawing")
done = False
...
while not done:
    ...
    points = [p1, p2, p3, p4]
    #curr_length = int(factor * curr_length)
    curr_length += adder
...
filepath = "/c/Users/17fry/Documents/Development/spirals/"
filename = input("Enter filename or 0 to quit: ")
if filename != '0':
